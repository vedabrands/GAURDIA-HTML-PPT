...
export const EngineSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* 6 Engine Cards Grid */}
      <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 my-4">
        {modules.map((mod, idx) => {
          const Icon = mod.icon;
          ...
          return (
            <BlurReveal key={mod.id} delay={0.1 + idx * 0.05} yOffset={25}>
              <motion.div
              ...
              >
                <div>
                  ...
                  <div
                    className={`text-[11px] font-mono font-bold mb-2 transition-colors ${
      ...
      <BlurReveal delay={0.25} yOffset={30}>
        <motion.div
          ...
          className="relative z-10 bg-[#12161D] hover:bg-[#161C25] rounded-2xl p-6 text-white border-2 border-[#222934] hover:border-[#B81D13] shadow-xl hover:shadow-[0_25px_45px_-10px_rgba(184,29,19,0.35)] transition-all duration-300"
        >
